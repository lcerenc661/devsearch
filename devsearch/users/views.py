...
from .utils import searchProfiles, paginateProfiles, getCustomRange

def profile(request):
    profiles, search_query = searchProfiles(request)
    results = 6
    page, paginator, profiles = paginateProfiles(request, profiles, results)
...
def user_profile(request, pk):
    ...
    context = {'profileObj': profileObj, 'topSkills': topSkills, 'otherSkills': otherSkills}
